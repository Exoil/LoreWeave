...
public class ConnectFactToCharacterCommandHandlerTest
{
    ...
    public async Task InvokeAsync_WhenCharacterAndFactExist_ReturnsSuccess()
    {
        // Arrange
        ...
        // Assert
        result.IsSuccess.ShouldBeTrue("Connect should succeed when character and fact exist");
